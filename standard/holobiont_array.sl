...
#SBATCH --time=03:00:00              # Adjust based on your simulation time
#SBATCH --mem=5G                     # Memory per task
#SBATCH --cpus-per-task=1            # 1 CPU per simulation
#SBATCH --array=1-240     # Replace ARRAY_MAX with actual number; %200 limits concurrent jobs
...
cd /nesi/nobackup/uoa04039/Holobiont_PopGen/Simulations_26Nov/simulations_pogen_heatwave/Rerun_sims_array_28Nov
